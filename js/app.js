// =======================================================
// ARCHIVO: js/app.js (VERSIÓN FINAL)
// =======================================================

// CRÍTICO: Esperamos a que todo el HTML y el SDK de Supabase se carguen 
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function cargarOpcionesBusqueda() {
        ...
        // Consulta: Busca clientes por coincidencia parcial (ilike)
    ...
    async function autocompletarDetalles() {
        ...
        inputCodigoPostal.value = data.codigo_postal; // CORREGIDO: Ahora rellena el valor
        inputLocalidad.value = data.localidad;       // CORREGIDO: Ahora rellena el valor
        inputProvincia.value = data.provincia;       // CORREGIDO: Ahora rellena el valor
    ...
    formularioMedicion.addEventListener('submit', async (e) => {
        ...
        const datosMedicion = {
            ...
            // Usamos las variables selectores que definimos arriba
        ...
        if (error) {
            ...
            window.print(); // Imprimir el documento
